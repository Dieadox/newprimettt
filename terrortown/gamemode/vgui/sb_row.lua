...
--Admin Ranks
if ply:IsUserGroup("srv_owner") then
...
if ply:IsUserGroup("trusted") then
  ...
  self.cols[5]:SetTextColor(Color(50,205,50))
end

--VIP Ranks
if ply:IsUserGroup("silver") then
  self.cols[5]:SetText("Silver")
  self.cols[5]:SetTextColor(Color(192,192,192))
end

if ply:IsUserGroup("gold") then
  self.cols[5]:SetText("Gold")
  self.cols[5]:SetTextColor(Color(255,215,0))
end

if ply:IsUserGroup("diamond") then
  self.cols[5]:SetText("Diamond")
  self.cols[5]:SetTextColor(Color(0,204,204))
end

if ply:IsUserGroup("elite") then
  self.cols[5]:SetText("Elite")
  self.cols[5]:SetTextColor(Color(30,30,30))
end
