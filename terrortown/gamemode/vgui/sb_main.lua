...
if SERVER then
resource.AddSingleFile("VGUI/ttt/np_logo.png")
end
...
surface.CreateFont("treb_small", {font = "Trebuchet18",
                                  size = 14,
                                  weight = 700})
surface.CreateFont("treb_large", {font = "Trebuchet18",
                                  size = 32,
                                  weight = 700})

logo = Material("vgui/ttt/np_logo.png")
...
local colors = {
   bg = Color(30,30,30, 250),
   bar = Color(50,50,50,255)
};
...
function PANEL:Paint()
   ...
   surface.DrawTexturedRect( 5, -31, 200, 200 )
...
--   gui.EnableScreenClicker(scrolling)
   ...
   self.hostname:SetPos(w - self.hostname:GetWide() - 8, y_logo_off +23)
...
function PANEL:ApplySchemeSettings()
   self.hostname:SetFont("treb_large")
